...
public:
     ...
     * @param internalLoadParam The internal load of the source, defaulting to an impedance of 0.0.
     */
    DCSource(double value, Load internalLoadParam = Load(0.0, 0.0, Load::RepresentationMode::POLAR_DEGREES));
